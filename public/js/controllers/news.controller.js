...
function newsController($scope, NewsService) {
  ...
  $scope.news = [
    ...
    {id: 2, link: '#!news/2', title: 'Title 2', content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Enim aperiam maiores excepturi similique, quam a omnis sint doloremque eligendi modi numquam, explicabo alias libero aspernatur temporibus officiis impedit assumenda?'},    
  ];
